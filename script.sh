...
rm /jffs/ads
curl -k -o /jffs/ads/adhosts.txt https://winhelp2002.mvps.org/hosts.txt
grep addn-hosts /tmp/dnsmasq.conf || echo "addn-hosts=/jffs/ads/adhosts.txt" >> /tmp/dnsmasq.conf
curl -k -o /jffs/ads/adhosts.txt https://winhelp2002.mvps.org/hosts.txt
grep addn-hosts /tmp/dnsmasq.conf || echo "addn-hosts=/jffs/ads/adhosts.txt" >> /tmp/dnsmasq.conf
killall dnsmasq
